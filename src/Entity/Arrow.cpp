...
{
    m_aabb = AABBf(-glm::vec3(0.04f, 0.04f, 0.375f), glm::vec3(0.04f, 0.04f, 0.375f));
...
void ArrowEntity::tick(float delta)
{
    ...
    AABBf search_box = AABBf::from_center_extent(get_global_transform().position(), glm::vec3(0.2f));
